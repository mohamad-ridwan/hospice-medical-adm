...
const APIPutBioPatientInCounter = (_id, data)=>useFetch(endpoint.putBioPatientInCounter(_id), 'PUT', data)
...
const APIPutBioPatientInFinishTreatment = (_id, data)=>useFetch(endpoint.putBioPatientInFinishTreatment(_id), 'PUT', data)
