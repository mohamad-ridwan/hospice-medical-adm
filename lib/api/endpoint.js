...
const putBioPatientInCounter = (_id)=>`v16/loket/put/loket-rules/patient-queue/bio-patient/${_id}`
...
const putBioPatientInFinishTreatment = (_id)=>`v17/finished-treatment/put/rules-treatment/patient-registration/${_id}`
